...
export const Sidebar = ({ toggleSidebar }) => {
  return (
    <div className="mt-1 w-full p-4">
      <h1 className="text-xs font-medium py-1 text-[#2A6DB0]">MENU</h1>
      <div className="flex py-2 flex-col gap-3">
        {/* Menu 1 */}
        <Link to={"/"}>
          <div className="flex items-center py-2 gap-4 group hover:bg-gray-300 hover:rounded-xl hover:px-3 w-full hover:cursor-pointer">
        ...
        <Link to={"/todolist"}>
          <div className="flex items-center py-2 gap-4 group hover:bg-gray-300 hover:rounded-xl hover:px-3 w-full hover:cursor-pointer">
            <div className="bg-[#EAEEF5] px-2 py-1">
              <RiTodoFill size={17} />
            </div>
